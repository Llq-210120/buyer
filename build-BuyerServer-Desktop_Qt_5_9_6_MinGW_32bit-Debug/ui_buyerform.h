...
public:
    ...
    void setupUi(QWidget *BuyerForm)
    {
        if (BuyerForm->objectName().isEmpty())
            BuyerForm->setObjectName(QStringLiteral("BuyerForm"));
        BuyerForm->resize(800, 500);
        BuyerForm->setStyleSheet(QString::fromUtf8("\n"
"\n"
"*{\n"
...
"\n"
""));
        pushButton = new QPushButton(BuyerForm);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(550, 250, 93, 28));
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/xiugai.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton->setIcon(icon);
        tableWidget = new QTableWidget(BuyerForm);
...
"}\n"
""));
        widget = new QWidget(BuyerForm);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(490, 90, 212, 103));
    ...
    void retranslateUi(QWidget *BuyerForm)
    {
        BuyerForm->setWindowTitle(QApplication::translate("BuyerForm", "Form", Q_NULLPTR));
        pushButton->setText(QApplication::translate("BuyerForm", "\344\277\256\346\224\271", Q_NULLPTR));
        label->setText(QApplication::translate("BuyerForm", "id", Q_NULLPTR));
        label_2->setText(QApplication::translate("BuyerForm", "\345\220\215\345\255\227", Q_NULLPTR));
        label_3->setText(QApplication::translate("BuyerForm", "\346\200\247\345\210\253", Q_NULLPTR));
    } // retranslateUi
